...
/**
 * Messages handled by the {@link ExternalShuffleBlockHandler}, or
...
public abstract class BlockTransferMessage implements Encodable {
  ...
  public enum Type {
    ...
    HEARTBEAT(5), UPLOAD_BLOCK_DATA(6), UPLOAD_BLOCK_INDEX(7);
  ...
  public static class Decoder {
    ...
    public static BlockTransferMessage fromByteBuffer(ByteBuffer msg) {
      ...
      switch (type) {
        ...
        case 6: return UploadBlockData.decode(buf);
        case 7: return UploadBlockIndex.decode(buf);
